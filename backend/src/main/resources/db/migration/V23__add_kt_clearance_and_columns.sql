-- V20: Comprehensive schema alignment for Knowledge Transfer and HR Employee Management

-- 1. Users table HR fields
...
ALTER TABLE knowledge_transfer_cases ADD COLUMN IF NOT EXISTS title VARCHAR(255);
...
ALTER TABLE knowledge_transfer_cases ADD COLUMN IF NOT EXISTS reason_type VARCHAR(50);
...
ALTER TABLE knowledge_transfer_checklists ADD COLUMN IF NOT EXISTS item_name VARCHAR(255);
...
ALTER TABLE knowledge_transfer_submissions ADD COLUMN IF NOT EXISTS category VARCHAR(100);
ALTER TABLE knowledge_transfer_submissions ADD COLUMN IF NOT EXISTS title VARCHAR(255);
ALTER TABLE knowledge_transfer_submissions ADD COLUMN IF NOT EXISTS content TEXT;
...
ALTER TABLE knowledge_transfer_sessions ADD COLUMN IF NOT EXISTS title VARCHAR(255);
ALTER TABLE knowledge_transfer_sessions ADD COLUMN IF NOT EXISTS scheduled_at TIMESTAMPTZ;
